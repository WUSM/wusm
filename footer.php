    ...
    <div id="wusm-footer">
        ...
        <div class="wrapper clearfix">
            ...
            <div id="wusm-footer-right">
                <div id="wusm-social">
                    <a onclick="__gaTracker('send', 'event', 'wusm-footer', 'https://www.facebook.com/WUSTLmedicine.health', 'Facebook');" id="wusm-facebook" title="Facebook" href="https://www.facebook.com/WUSTLmedicine.health"><img src="<?php echo get_template_directory_uri(); ?>/_/img/facebook.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/facebook.png';this.onerror=null;"></a><a onclick="__gaTracker('send', 'event', 'wusm-footer', 'http://twitter.com/WUSTLmed', 'Twitter');" id="wusm-twitter" title="Twitter" href="http://twitter.com/WUSTLmed"><img src="<?php echo get_template_directory_uri(); ?>/_/img/twitter.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/twitter.png';this.onerror=null;"></a><a onclick="__gaTracker('send', 'event', 'wusm-footer', 'https://plus.google.com/106914955616933360045/', 'Google+');" id="wusm-google-plus" title="Google+" href="https://plus.google.com/106914955616933360045/"><img src="<?php echo get_template_directory_uri(); ?>/_/img/google-plus.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/google-plus.png';this.onerror=null;"></a>
                </div>
