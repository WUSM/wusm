<form name="search" method="get" id="search-form" autocapitalize="none" action="<?php echo esc_url( home_url( '/' ) ); ?>">
    ...
    <input type="image" class="submit" name="submit" id="search-btn" src="<?php echo get_template_directory_uri(); ?>/_/img/search.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/search.png';this.onerror=null;">
</form>