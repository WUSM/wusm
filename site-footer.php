	...
	<?php if ( $footer_menu || get_field( 'facebook', 'option' ) || get_field( 'twitter', 'option' ) || get_field( 'linkedin', 'option' ) || get_field( 'youtube', 'option' ) ) : ?>
		...
		<?php if ( get_field( 'facebook', 'option' ) || get_field( 'twitter', 'option' ) || get_field( 'linkedin', 'option' ) || get_field( 'youtube', 'option' ) ) : ?>
			...
			<?php if ( get_field( 'twitter', 'option' ) ) : ?>
				<a onclick="__gaTracker('send', 'event', 'site-footer', '', 'Twitter');" id="site-twitter" title="Twitter" href="<?php the_field( 'twitter', 'option' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/_/img/twitter.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/twitter.png';this.onerror=null;"></a>
			<?php endif; ?>
			<?php if ( get_field( 'instagram', 'option' ) ) : ?>
				<a onclick="__gaTracker('send', 'event', 'site-footer', '', 'Instagram');" id="site-instagram" title="Instagram" href="<?php the_field( 'instagram', 'option' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/_/img/instagram.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/instagram.png';this.onerror=null;"></a>
			<?php endif; ?>
			<?php if ( get_field( 'linkedin', 'option' ) ) : ?>
				<a onclick="__gaTracker('send', 'event', 'site-footer', '', 'LinkedIn');" id="site-linkedin" title="LinkedIn" href="<?php the_field( 'linkedin', 'option' ); ?>"><img src="<?php echo get_template_directory_uri(); ?>/_/img/linkedin.svg" onerror="this.src='<?php echo get_template_directory_uri(); ?>/_/img/linkedin.png';this.onerror=null;"></a>
			<?php endif; ?>
	...
	<?php if ( get_field( 'contact', 'option' ) || get_field( 'list_1', 'option' ) || get_field( 'list_2', 'option' ) ) : ?>
		...
		<?php if ( get_field( 'list1_links', 'option' ) || get_field( 'list2_links', 'option' ) ) : ?>
			<div id="lists">
				...
				<div id="col2">
					<?php
					if ( get_field( 'list1_title', 'option' ) ) :
						?>
					...
					<ul>
						<?php
						while ( have_rows( 'list1_links', 'option' ) ) :
							the_row();
							?>
				...
				<div id="col3">
					<?php
					if ( get_field( 'list2_title', 'option' ) ) :
						?>
						<strong><?php the_field( 'list2_title', 'option' ); ?></strong>
													  <?php
					endif;
					?>
					<ul>
						<?php
						while ( have_rows( 'list2_links', 'option' ) ) :
							the_row();
							?>
						<li><a href="<?php the_sub_field( 'url' ); ?>"><?php the_sub_field( 'link_text' ); ?></a></li>
						<?php endwhile; ?>
